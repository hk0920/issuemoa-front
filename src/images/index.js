...
export { default as home_thema } from "./icon/home_thema.png";
export { default as home_fill_thema } from "./icon/home_fill_thema.png";
export { default as word } from "./icon/word.png";
export { default as word_fill } from "./icon/word_fill.png";
export { default as word_thema } from "./icon/word_thema.png";
export { default as word_fill_thema } from "./icon/word_fill_thema.png";
export { default as tech } from "./icon/tech.png";
export { default as tech_fill } from "./icon/tech_fill.png";
export { default as tech_thema } from "./icon/tech_thema.png";
export { default as tech_fill_thema } from "./icon/tech_fill_thema.png";
export { default as person } from "./icon/person.png";
export { default as person_fill } from "./icon/person_fill.png";
export { default as person_thema } from "./icon/person_thema.png";
export { default as person_fill_thema } from "./icon/person_fill_thema.png";
export { default as more } from "./icon/more.png";
export { default as more_fill } from "./icon/more_fill.png";
export { default as more_thema } from "./icon/more_thema.png";
export { default as more_fill_thema } from "./icon/more_fill_thema.png";
...
export { default as grade_thema } from "./icon/grade_thema.png";
export { default as notice } from "./icon/notice.png";
export { default as notice_thema } from "./icon/notice_thema.png";
export { default as setting } from "./icon/setting.png";
export { default as setting_thema } from "./icon/setting_thema.png";
export { default as stock } from "./icon/stock.png";
export { default as stock_thema } from "./icon/stock_thema.png";
export { default as support_customer } from "./icon/support_customer.png";
export { default as support_customer_thema } from "./icon/support_customer_thema.png";
